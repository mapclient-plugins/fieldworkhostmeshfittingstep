...
class Ui_ConfigureDialog(object):
    def setupUi(self, ConfigureDialog):
        ...
        ConfigureDialog.resize(418, 508)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.lineEdit3)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.lineEdit4)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.lineEdit5)
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.lineEdit6)

        self.label7 = QLabel(self.configGroupBox)
        self.label7.setObjectName(u"label7")

        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.label7)

        self.lineEdit7 = QLineEdit(self.configGroupBox)
        self.lineEdit7.setObjectName(u"lineEdit7")

        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.lineEdit7)
        ...
        self.formLayout.setWidget(8, QFormLayout.LabelRole, self.label9)

        self.lineEdit9 = QLineEdit(self.configGroupBox)
        self.lineEdit9.setObjectName(u"lineEdit9")

        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.lineEdit9)
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.lineEdit10)
    ...
    def retranslateUi(self, ConfigureDialog):
        ...
        self.label1.setText(QCoreApplication.translate("ConfigureDialog", u"GUI:  ", None))
        self.label2.setText(QCoreApplication.translate("ConfigureDialog", u"fit mode:  ", None))
        self.label3.setText(QCoreApplication.translate("ConfigureDialog", u"host element type:  ", None))
        self.label4.setText(QCoreApplication.translate("ConfigureDialog", u"slave mesh discretisation:  ", None))
        self.label5.setText(QCoreApplication.translate("ConfigureDialog", u"slave sobelov discretisation:  ", None))
        self.label6.setText(QCoreApplication.translate("ConfigureDialog", u"slave sobelov weight:  ", None))
        self.label7.setText(QCoreApplication.translate("ConfigureDialog", u"slave normal discretisation:  ", None))
        self.label8.setText(QCoreApplication.translate("ConfigureDialog", u"slave normal weight:  ", None))
        self.label9.setText(QCoreApplication.translate("ConfigureDialog", u"max iterations:  ", None))
        self.label10.setText(QCoreApplication.translate("ConfigureDialog", u"host sobelov discretisation:  ", None))
        self.label11.setText(QCoreApplication.translate("ConfigureDialog", u"host sobelov weight:  ", None))
        self.label12.setText(QCoreApplication.translate("ConfigureDialog", u"n closest points:  ", None))
        self.label13.setText(QCoreApplication.translate("ConfigureDialog", u"kdtree args:  ", None))
        self.label14.setText(QCoreApplication.translate("ConfigureDialog", u"verbose:  ", None))
    # retranslateUi
