...
class Ui_ConfigureDialog(object):
    def setupUi(self, ConfigureDialog):
        ...
        ConfigureDialog.resize(418, 539)
        ...
        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.label6)

        self.lineEdit6 = QLineEdit(self.configGroupBox)
        self.lineEdit6.setObjectName(u"lineEdit6")

        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.lineEdit6)

        self.label7 = QLabel(self.configGroupBox)
        self.label7.setObjectName(u"label7")

        self.formLayout.setWidget(7, QFormLayout.LabelRole, self.label7)

        self.lineEdit7 = QLineEdit(self.configGroupBox)
        self.lineEdit7.setObjectName(u"lineEdit7")

        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.lineEdit7)
        ...
        self.formLayout.setWidget(9, QFormLayout.LabelRole, self.label9)

        self.lineEdit9 = QLineEdit(self.configGroupBox)
        self.lineEdit9.setObjectName(u"lineEdit9")

        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.lineEdit9)

        self.label10 = QLabel(self.configGroupBox)
        self.label10.setObjectName(u"label10")

        self.formLayout.setWidget(10, QFormLayout.LabelRole, self.label10)

        self.lineEdit10 = QLineEdit(self.configGroupBox)
        self.lineEdit10.setObjectName(u"lineEdit10")

        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.lineEdit10)
        ...
        self.formLayout.setWidget(14, QFormLayout.LabelRole, self.label14)

        self.lineEdit14 = QLineEdit(self.configGroupBox)
        self.lineEdit14.setObjectName(u"lineEdit14")

        self.formLayout.setWidget(14, QFormLayout.FieldRole, self.lineEdit14)
